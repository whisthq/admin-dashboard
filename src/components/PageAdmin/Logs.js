...
class Logs extends Component {
  ...
  formatTime = (log) => {
    ...
    if (hour < 0) {
      return (
        Math.abs(hour).toString() + ":" + timeArr[1] + " AM (" + logArr[0] + ")"
      );
    } else {
      return (
        Math.abs(hour).toString() + ":" + timeArr[1] + " PM (" + logArr[0] + ")"
      );
    }
  };
                ...
                this.props.logs_not_found ? (
                  ...
                  >
                            ...
                            >
                              ...
                              <td style={{ width: 100 }}>
                                <a
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  href={value["client_logs"]}
                                  style={{
                                    background: "rgba(2, 207, 57, 0.1)",
                                    padding: "10px 12px",
                                    borderRadius: 2,
                                    fontWeight: "bold",
                                  }}
                                >
                                  <span style={{ color: "#02cf39" }}>
                                    Client Logs
                                  </span>
                                </a>
                              </td>
                              ...
                              <Button
                                onClick={() =>
                                  this.deleteLogs(value["connection_id"])
                                }
                                style={{
                                  marginLeft: 40,
                                  color: "#111111",
                    ...
                    Math.min(20, this.state.last_index) <
                      this.props.logs.length ? (
                      <div
                        style={{ marginTop: 20, color: "#5ec3eb" }}
