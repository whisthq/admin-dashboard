...
describe('Account reducer', () => {
    ...
    const testData = [
        ...
        },
        {
            ...
            actionMessage: AccountAction.loadVMs('payload'),
            startState: {},
            endState: {
                vm_info: 'payload',
                vmsUpdated: true,
        ...
        },
        {
            ...
            actionMessage: AccountAction.fetchDiskTable(false),
            startState: {},
            endState: {
                disks_fetched: false,
            },
        },
        {
            ...
            actionMessage: AccountAction.diskTableFetched('payload'),
            startState: {},
            endState: {
                disk_info: 'payload',
                disks_fetched: true,
        ...
        },
        {
            ...
            actionMessage: AccountAction.fetchVMs(true),
            startState: {},
            endState: {
                vmsUpdated: true,
            },
        },
        {
            ...
            actionMessage: AccountAction.userActivityFetched('payload'),
            startState: {},
            endState: {
        ...
        },
        {
            ...
            actionMessage: AccountAction.fetchUserTable(true),
            startState: {},
            endState: {
                usersUpdated: true,
            },
        },
        {
            ...
            actionMessage: AccountAction.userTableFetched('payload'),
            startState: {},
            endState: {
                userTable: 'payload',
            },
        },
        {
            ...
            actionMessage: AccountAction.storeJWT('access', 'refresh'),
            startState: {},
            endState: {
                access_token: 'access',
        ...
        },
        {
            ...
            actionMessage: AccountAction.startVM('vm_name'),
        ...
        },
        {
            ...
            actionMessage: AccountAction.deallocateVM('vm_name'),
            startState: { vms_updating: [] },
            endState: {
                vms_updating: ['vm_name'],
            },
        ...
        },
        {
            ...
            actionMessage: AccountAction.doneUpdating('vm_name'),
        ...
        },
        {
            ...
            actionMessage: AccountAction.fetchLogs('username', true, true),
            startState: {},
            endState: {
        ...
        },
        {
            ...
            actionMessage: AccountAction.logsFound(false),
            startState: {},
            endState: {
                logs_not_found: false,
            },
        },
        {
            ...
            actionMessage: AccountAction.deleteLogSuccess('connection_id'),
            startState: {
                logs: [
                    {
        ...
        },
        {
            ...
            actionMessage: AccountAction.latestReportFetched('report'),
            startState: {},
            endState: {
                latestReport: 'report',
            },
        },
        {
            ...
            actionMessage: AccountAction.userReportFetched('report'),
            startState: {},
            endState: {
                userReport: 'report',
            },
        },
        {
            ...
            actionMessage: AccountAction.regionReportFetched('report'),
            startState: {},
            endState: {
                regionReport: 'report',
            },
        },
        {
            ...
            actionMessage: AccountAction.totalSignupsFetched(3),
            startState: {},
            endState: {
                totalSignups: 3,
            },
        },
        {
            ...
            actionMessage: AccountAction.totalMinutesFetched(10),
            startState: {},
            endState: {
                totalMinutes: 10,
            },
        },
        {
            ...
            actionMessage: AccountAction.changePage('page'),
            startState: {},
            endState: {
                page: 'page',
            },
    ...
    for (let i = 0; i < testData.length; ++i) {
        ...
        test(`testing whether ${
            ...
            expect(
                accountReducer(testParams.startState, testParams.actionMessage)
